...
export default function About() {
  ...
  return (
    <>
      <div ref={containerRef} className="bg-background text-foreground light relative">
        ...
        <Container>
            ...
            <div className="flex flex-col items-center gap-8 lg:gap-12">
              ...
              <div className="flex flex-col items-center gap-6 lg:gap-8 text-center max-w-[980px]">
                <motion.h3
                  ...
                  className="heading-2 flex flex-wrap gap-x-2 justify-center overflow-hidden"
                >
                ...
                <motion.h5
                  ...
                  className="heading-4 flex flex-wrap gap-x-2 justify-center" ref={heading5Ref}>
          ...
          <div className="flex items-center justify-between text-muted-foreground w-full py-12 text-base lg:text-xl font-heading max-w-[980px] mx-auto">
            <p>Scroll Down</p>
            <p>To See More</p>
          </div>
        </Container>
...
function AboutImage() {
  ...
  return (
    <div ref={containerRef} className="bg-white ">
      <motion.div style={{ clipPath }} className="bg-background relative text-foreground py-[48px] lg:py-[80px] flex flex-col gap-8">
        <div className=" py-12 w-screen overflow-x-hidden" data-scroll data-scroll-speed="0.1">
          <ScrollVelocity
            texts={['Full Stack Developer - Abdalla Emad']}
            velocity={60}
            className="text-6xl lg:text-9xl font-light"
          />
        </div>
